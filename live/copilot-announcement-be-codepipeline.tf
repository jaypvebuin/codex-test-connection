...
# locals {
#   cp_announcement_codebuild_config = [
#     # {
#     #   identifier                  = "cp-announcement-owasp"
...
#     #       security_group_ids = [module.cp-announcement-codebuild_sg["cp-announcement-owasp"].sg_id]
#     #     }
#     #   ]
...
#     #     {
#     #       name  = "SERVICE_NAME",
#     #       value = "cp-announcement-service",
#     #       type  = "PLAINTEXT"
#     #     },
#     #     {
#     #       name  = "project_name",
#     #       value = "vb-jugaad-cp-announcement-service",
#     #       type  = "PLAINTEXT"
#     #     }
#     #   ]
#     # },
#     {
#       identifier                  = "cp-announcement-sonarqube"
#       build_compute_type          = "BUILD_GENERAL1_SMALL"
#       build_environment_image     = "aws/codebuild/standard:6.0"
#       build_environment_type      = "LINUX_CONTAINER"
#       image_pull_credentials_type = "CODEBUILD"
...
#           vpc_id             = var.vpc_id[var.environment],
#           subnets            = var.subnet_ids[var.environment],
#           security_group_ids = [module.cp-announcement-codebuild_sg["cp-announcement-sonarqube"].sg_id]
#         }
#       ]
...
#     },
#     {
#       identifier                  = "cp-announcement-app"
#       build_compute_type          = "BUILD_GENERAL1_SMALL"
#       build_environment_image     = "aws/codebuild/standard:6.0"
#       build_environment_type      = "LINUX_CONTAINER"
#       image_pull_credentials_type = "CODEBUILD"
...
#       codebuild_role_policy_arn = ["${module.iam_policy["cp-announcement-be-codebuild"].policy_arn}"]

#       vpc_config = [
#         {
#           vpc_id             = var.vpc_id[var.environment],
#           subnets            = var.subnet_ids[var.environment],
#           security_group_ids = [module.cp-announcement-codebuild_sg["cp-announcement-app"].sg_id]
#         }
#       ]
...
#         {
#           name  = "container_name",
#           value = "vb-jugaad-cp-announcement-task-definition-${var.environment}-container",
#           type  = "PLAINTEXT"
#         },
#         {
#           name  = "ecr_repo",
#           value = "vb-jugaad-cp-announcement-service-repo-${var.environment}",
#           type  = "PLAINTEXT"
#         },
#         {
#           name  = "SERVICE_NAME",
...
#     }
#   ]
#   cp_announcement_codebuild_configs_map = { for idx, config in local.cp_announcement_codebuild_config : config.identifier => config }
# }

# # codebuild module

# module "cp-announcement-codebuild" {
#   for_each = {
#     for identifier, config in local.cp_announcement_codebuild_configs_map :
#     identifier => config if(
#       (var.environment == "dev" && (identifier == "cp-announcement-sonarqube" || identifier == "cp-announcement-app")) ||
#       (var.environment != "dev" && identifier == "cp-announcement-app")
#     )
#   }
...
#   depends_on = [module.cp-announcement-codebuild_sg]
...
# locals {
#   cp_announcement_pipeline_configs = [{
#     identifier = "cp-announcement-service"
#     #------------ artifact_bucket.tf ---------------
...
#               FullRepositoryId = "vebuin/jugaad-cp-announcement"
...
#           #   configuration = {
#           #     ProjectName = module.cp-announcement-codebuild["cp-announcement-owasp"].codebuild_name
#           #   }
#           # },
#           {
...
#             configuration = {
#               ProjectName = module.cp-announcement-codebuild["cp-announcement-sonarqube"].codebuild_name
#             }
#           }
#         ]
#       } : null,
...
#             configuration = {
#               ProjectName = module.cp-announcement-codebuild["cp-announcement-app"].codebuild_name
#             }
#           }
#         ]
#       },
...
#               ServiceName = "vb-jugaad-cp-announcement-service-${lower(var.environment)}"
...
#   cp_announcement_pipeline_configs_map = { for idx, config in local.cp_announcement_pipeline_configs : config.identifier => config }
# }

# # codepipeline module

# module "cp-announcement-pipeline" {
#   source   = "../modules/CodePipeline/pipeline"
#   for_each = local.cp_announcement_pipeline_configs_map
...
#     }
#   ]
#   cp_announcement_sg_configs_map = { for idx, config in local.cp_announcement_sg_configs : config.identifier => config }
# }

# module "cp-announcement-codebuild_sg" {
#   source   = "../modules/CodePipeline/codebuild_sg"
#   for_each = local.cp_announcement_sg_configs_map
